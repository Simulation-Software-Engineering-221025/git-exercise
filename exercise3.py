...
class Rectangle:
    ...
    def contains(self, point: Point2D, tolerance: float = 0.0) -> bool:
        ...
        return (
            self.is_in_interval(ll_px, 0.0, self._dx, tolerance) and
            self.is_in_interval(ll_py, 0.0, self._dy, tolerance)
        )
    ...
    def is_in_interval(self, value: float, lower: float, upper: float, tolerance: float = 0.0) -> bool:
